...
GST_DEBUG_CATEGORY_STATIC (gstti_imgdec_debug);
#define GST_CAT_DEFAULT gstti_imgdec_debug
...
static void gstti_imgdec_install_properties(GObjectClass *gobject_class){
...
static void gstti_imgdec_set_property(GObject *object, guint prop_id,
    const GValue *value, GParamSpec *pspec)
{
    GstTIDmaidec *dmaidec = (GstTIDmaidec *)object;
    IMGDEC_Params *params = (IMGDEC_Params *)dmaidec->params;
...
static void gstti_imgdec_get_property(GObject *object, guint prop_id,
...
/******************************************************************************
 * gst_tiimgdec_setup_params
 *****************************************************************************/
static gboolean gstti_imgdec_setup_params(GstTIDmaidec *dmaidec){
    IMGDEC_Params *params;
    IMGDEC_DynamicParams *dynParams;

    /* Initialize GST_LOG for this object */
    GST_DEBUG_CATEGORY_INIT(gstti_imgdec_debug, "TIImgdec", 0,
        "DMAI Image1 Decoder");

    if (!dmaidec->params){
        dmaidec->params = g_malloc0(sizeof (IMGDEC_Params));
    }
    if (!dmaidec->dynParams){
        dmaidec->dynParams = g_malloc0(sizeof (IMGDEC_DynamicParams));
    }
    *(IMGDEC_Params *)dmaidec->params     = Idec_Params_DEFAULT;
    *(IMGDEC_DynamicParams *)dmaidec->dynParams  = Idec_DynamicParams_DEFAULT;
    params = (IMGDEC_Params *)dmaidec->params;
    dynParams = (IMGDEC_DynamicParams *)dmaidec->dynParams;
...
/******************************************************************************
 * gst_tiimgdec_set_codec_caps
 *****************************************************************************/
static void gstti_imgdec_set_codec_caps(GstTIDmaidec *dmaidec){
    IMGDEC_Params *params = (IMGDEC_Params *)dmaidec->params;
    IMGDEC_DynamicParams *dynParams = (IMGDEC_DynamicParams *)dmaidec->dynParams;
...
static gboolean gstti_imgdec_create (GstTIDmaidec *dmaidec)
{
    GST_DEBUG("opening image decoder \"%s\"\n", dmaidec->codecName);
    dmaidec->hCodec =
        Idec_create(dmaidec->hEngine, (Char*)dmaidec->codecName,
            (IMGDEC_Params *)dmaidec->params,
            (IMGDEC_DynamicParams *)dmaidec->dynParams);
...
static void gstti_imgdec_destroy (GstTIDmaidec *dmaidec)
{
    g_assert (dmaidec->hCodec);
    Idec_delete(dmaidec->hCodec);
}

static gboolean gstti_imgdec_process(GstTIDmaidec *dmaidec, GstBuffer *encData,
    ...
    ret = Idec_process(dmaidec->hCodec, hEncData, hDstBuf);
...
static gint gstti_imgdec_get_in_buffer_size(GstTIDmaidec *dmaidec){
    return Idec_getInBufSize(dmaidec->hCodec);
}

static gint gstti_imgdec_get_out_buffer_size(GstTIDmaidec *dmaidec){
    return Idec_getOutBufSize(dmaidec->hCodec);
 }
 
struct gstti_decoder_ops gstti_imgdec_ops = {
    .xdmversion = "xDM 1.0",
    .codec_type = IMAGE,
    .default_setup_params = gstti_imgdec_setup_params,
    .set_codec_caps = gstti_imgdec_set_codec_caps,
    .install_properties = gstti_imgdec_install_properties,
    .set_property = gstti_imgdec_set_property,
    .get_property = gstti_imgdec_get_property,
    .codec_create = gstti_imgdec_create,
    .codec_destroy = gstti_imgdec_destroy,
    .codec_process = gstti_imgdec_process,
    .get_in_buffer_size = gstti_imgdec_get_in_buffer_size,
    .get_out_buffer_size = gstti_imgdec_get_out_buffer_size,
    .outputUseMask = 0,
};
